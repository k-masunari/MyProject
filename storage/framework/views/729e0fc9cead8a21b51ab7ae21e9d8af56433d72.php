...
<div class="row">
  ...
  <div class="col-sm-2 sidebar">
    <h1 class="logo">
        <a href="./index.html">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="ESA ACADEMY 生徒管理システム" class="img-fluid">
        </a>
    </h1>
    <nav>
      <ul>
        <li>
            <a href="./sign-up.html" class="sign-up-btn">
                <i class="fas fa-plus"></i>新規登録画面
            </a>
        </li>
        <li>
            <a href="./index.html" class="top-page-btn">
...
<?php /**PATH /Users/masunarikengo/myProject/resources/views/home.blade.php ENDPATH**/ ?>